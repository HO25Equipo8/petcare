...
import Bookings from './tabs-panel/Bookings.jsx';
import Profile from './tabs-panel/Profile.jsx';
import Schedule from './tabs-panel/Schedule.jsx';
import CreateService from './modals/CreateService.jsx';
import EditService from './modals/EditService.jsx';
import CreateDiscount from './modals/CreateDiscount.jsx';
import CreateCombo from './modals/CreateCombo.jsx';
import ServicesManagement from './tabs-panel/ServicesManagement.jsx';
import Discounts from './tabs-panel/Discounts.jsx';
import ComboOffering from './tabs-panel/ComboOffering.jsx';
import Simulator from './tabs-panel/Simulator.jsx'
  ...
  const toggleZoneStatus = (zoneId) => {
    ...
    const [comboOfferings, setComboOfferings] = useState([
      ...
      },
      {
        ...
        discount: 20,
        offeringIds: [2, 7, 3], // walk-extended, grooming, playtime
        originalPrice: 8500,
        finalPrice: 6800,
        active: true
      },
      {
        ...
        discount: 30,
        offeringIds: [2, 8, 3, 6, 9], // walk-extended, grooming-premium, playtime, feeding-special, training
        originalPrice: 15000,
        finalPrice: 10500,
        active: true
      },
      {
        ...
        discount: 18,
        offeringIds: [4, 7, 9], // socialization, grooming, training
        originalPrice: 11000,
        finalPrice: 9020,
        active: true
      }
    ...
    // Plan Discount Rules management functions
